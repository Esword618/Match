<template>
  <a-layout class="layout">
    ...
    <a-layout-content class="layout-content" :style="{ height: contentHeight }">
      ...
      />
      <!-- RawData展示 -->
      <RawDtaChart :isok="isok"></RawDtaChart>
      <div class="img-group">
        <!-- <img class="img" :src="ImgSrc0" /> -->
        <a-image
          :width="300"
          :src="ImgSrc"
...
export default {
  ...
  created() {
    ...
    setInterval(function () {
      if (self.isok) {
        http.GetImgName().then((response) => {
          let FileName = response.data.data.info;
          console.log(FileName);
          self.ImgSrc =
            "http://127.0.0.1:8000/api/showImg?filename=" + FileName;
